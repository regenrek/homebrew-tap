class Peky < Formula
  ...
  url "https://github.com/regenrek/peakypanes/archive/refs/tags/v0.0.37.tar.gz"
  sha256 "a1eccbe3317c5ae67747d31ad133a3136e6b339db8a41d67e4adca84c4e18f97"
  depends_on "go" => :build

  def install
    ldflags = "-s -w -X main.version=0.0.37"
