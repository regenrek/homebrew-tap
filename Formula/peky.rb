class Peky < Formula
  ...
  url "https://github.com/regenrek/peakypanes/archive/refs/tags/v0.0.32.tar.gz"
  sha256 "7cc138db205c6b372d0e85b76ad1bca75c9e380b5afea3940e12d966db2a8b3f"
  depends_on "go" => :build

  def install
    ldflags = "-s -w -X main.version=0.0.32"
