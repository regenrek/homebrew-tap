class Peky < Formula
  ...
  url "https://github.com/regenrek/peakypanes/archive/refs/tags/v0.0.38.tar.gz"
  sha256 "7f76fbcc21b7ab85c7fff5d6d2c41a1ef45d10b44326e930ea83b401a9d25088"
  depends_on "go" => :build

  def install
    ldflags = "-s -w -X main.version=0.0.38"
